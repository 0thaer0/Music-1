...
client.on('ready', () => {
   console.log(`----------------`);
      console.log(`MautBot- Script By : Maut`);
        console.log(`----------------`);
      console.log(`ON ${client.guilds.size} Servers '     Script By : Maut ' `);
    console.log(`----------------`);
  console.log(`Logged in as ${client.user.tag}!`);
client.user.setGame(`.bc `,"http://twitch.tv/iiMaut Gamer")
...
https://discord.gg/f3eYCX7
            **`);
            message.channel.sendEmbed(help); // رابط السيرفر يعود الى سيرفر Redk7 Gang .
    }
});
